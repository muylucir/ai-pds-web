...
export const normalTurn: AgentEvent[] = [
  { kind: "status", text: "요청을 분석하고 있습니다…", path: null, payload: null },
  { kind: "file_changed", text: null, path: "prototype/src/components/FilterBar.tsx", payload: null },
  { kind: "message", text: "기획전 필터 기능을 추가했습니다.", path: null, payload: null },
  { kind: "message", text: " 우측 프리뷰에서 확인해 주세요.", path: null, payload: null },
...
export const errorTurn: AgentEvent[] = [
  { kind: "status", text: "프로토타입 빌드를 시작합니다…", path: null, payload: null },
  { kind: "error", text: "빌드에 실패했습니다: 의존성 설치 오류", path: null, payload: null },
];
...
export const questionsTurn: AgentEvent[] = [
  { kind: "status", text: "Product Strategy 질문지를 생성하고 있습니다…", path: null, payload: null },
  {
    kind: "file_changed",
    text: null,
  ...
  { kind: "message", text: "포지셔닝·차별화·비즈니스 모델에 관한 13개 질문을 준비했습니다.", path: null, payload: null },
  { kind: "done", text: null, path: null, payload: null },
];

export const documentTurn: AgentEvent[] = [
  { kind: "status", text: "Discovery Document를 갱신하고 있습니다…", path: null, payload: null },
  { kind: "file_changed", text: null, path: "aiplc-docs/discovery/discovery-document.md", payload: null },
  { kind: "message", text: "PR/FAQ를 Discovery Document에 작성했습니다.", path: null, payload: null },
  { kind: "done", text: null, path: null, payload: null },
];
